# Contributing to enquirer-readline

First and foremost, thank you! We appreciate that you want to contribute to enquirer-readline, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for enquirer-readline**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for enquirer-readline:

- star the [project](https://github.com/jonschlinkert/enquirer-readline)
- tweet your support for enquirer-readline
...
- **version**: please note the version of enquirer-readline are you using
...
[so]: http://stackoverflow.com/questions/tagged/enquirer-readline